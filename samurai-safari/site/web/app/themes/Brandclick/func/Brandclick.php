<?php 
namespace Brandclick;
use Brandclick\Register\RegisterShortcodes;
use Brandclick\Vendor\AcfSettings;
use Brandclick\Vendor\Wpcf7Settings;
use Brandclick\Tracking\AnalyticsReportingApi;
use Brandclick\Settings\CleanUpWordPress;
use Brandclick\Settings\RestApiSettings;
use Brandclick\Admin\DebuggerSettings;
use Brandclick\DataAPI\CreateStoreGeojson;
use Brandclick\DataAPI\ProcessExternalXML;
use Brandclick\Register\RegisterRedirects;

use Brandclick\Tracking\WcCreateProductObjects;

// Woocommmerce 
use Brandclick\Woocommerce\WcReset;

abstract class Brandclick {

    const VERSION = 0.01;
    const THEME_SLUG = 'brandclick';
    ...
    {   
        ...
        $analytics_reporting_api    = new AnalyticsReportingApi();
        $register_redirects         = new RegisterRedirects();
