...
<head>
    ...
    <?php if( $GTM = get_option('google_tag_manager_id') ) : ?>
        ...
        })(window,document,'script','dataLayer','GTM-TPGX899');</script>
...
<body <?php body_class(); ?> >
    ...
    <?php if( $GTM ) : ?>
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TPGX899"
                ...
                <div class="brand-wrapper">
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="home">
                        <?php 
                            ...
                            $image = $image ? $image : trailingslashit(get_stylesheet_directory_uri()) . 'assets/dist/img/logo.png';
                        ?>
